class PlayerMenu extends Menu {
    ...
    */
    ...
    /*
        Method Name: pause
        Method Parameters: None
        Method Description: Pauses the playback
        Method Return: void
    */
    pause(){
    ...
    /*
        Method Name: unpause
        Method Parameters: None
        Method Description: Resumes playback
        Method Return: void
    */
    unpause(){
    ...
    */
    ...
    /*
        Method Name: display
        Method Parameters: None
        Method Description: Displays the menu
        Method Return: void
    */
    display(){
    ...
    /*
        Method Name: updateComponentYValues
        Method Parameters: 
            textValues:
                An object with string values for different text boxes
        Method Description: Updates the placement and size of text boxes
        Method Return: void
    */
