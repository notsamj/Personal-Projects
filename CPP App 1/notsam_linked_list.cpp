    ...
    */
    ...
    void insert(T value, int index){
        ...
        if (index > size || index < 0){
            cerr << "Invalid insertion index! (" << index << '\n';
            return; 
        }
    ...
    DLLNode getNode(int index){
        ...
        if (this.getSize() < index + 1 || index < 0){
            cerr << "Issue @ Index: " << index << "(List Size: " << this.getSize() << ")\n";
            return;
        }
...
class DLLNode<T> {
    ...
    /*
        ...
        Method Return: constructor
    */
    DLLNode(DLLNode previous, DLLNode value){
        this.value = value;
