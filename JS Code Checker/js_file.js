...
class JSFile {
    ...
    gatherNSRequirementData(){
        ...
        let extractClassName = (str, searchStartIndex) => {
            ...
            let whiteSpace = /\s/;
            //console.log("Called with", str, searchStartIndex)
            for (let i = searchStartIndex; i < str.length; i++){
                let char = str[i];
                //console.log(char, stage, whiteSpace.test(char))
        ...
        */
        ...
        for (let match of interfaceMatches){
            ...
            //console.log("Read interface name", interfaceName, match["index"], matchStr)
    ...
    commentClass(classDetailsJSON){
        ...
        //console.log(this.getFileName(), charIndex, classDetailsJSON["char_index"])
